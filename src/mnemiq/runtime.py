...
class Runtime:
    ...
    def ask(
        ...
        packet = retrieve(
            ...
            # Certified metrics and dimensions were appended to the snapshot by `apply_certified`
            # and passed to nothing -- five of the fs corpus's twenty-eight records reaching the
            # model not at all, and the five carrying the most explicit meaning.
