...
def test_the_floor_reaches_the_provider(monkeypatch):
    ...
    assert _CapturingOpenAI.sent["max_completion_tokens"] == 1024
...
def test_the_judge_built_the_way_the_product_builds_it_clears_the_floor(monkeypatch):
